...
from celnav_core.core.reduction import compute_fix_error
...
| `SextantReading` | `body_name, hs, ho, utc, real_altitude, correction_total` | |
...
| Function | Returns | Notes |
|----------|---------|-------|
| `compute_ho(body_name, dt, real_pos, he_ft)` | `SextantReading` | Full sight: Hs, Ho, correction. Uses geometric alt for Ho |
...
| `compute_fix_error(fix, real_pos)` | `Fix` | Great-circle distance (haversine) in nmi |
